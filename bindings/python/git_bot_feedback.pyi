...
class DiffHunkHeader:
    ...
    @old_start.setter
    def old_start(self, val: int) -> None: ...
    @property
    def old_lines(self) -> int: ...
    @old_lines.setter
    def old_lines(self, val: int) -> None: ...
    @property
    def new_start(self) -> int: ...
    @new_start.setter
    def new_start(self, val: int) -> None: ...
    @property
    def new_lines(self) -> int: ...
    @new_lines.setter
    def new_lines(self, val: int) -> None: ...
...
class FileFilter:
    def __init__(
        self, ignored: list[str], extensions: list[str], log_scope: str | None = None
    ) -> None: ...
    def parse_submodules(self, manifest_path: str | None = None) -> None: ...
    def is_file_in_list(self, file_path: str | Path, ignore: bool) -> bool: ...
